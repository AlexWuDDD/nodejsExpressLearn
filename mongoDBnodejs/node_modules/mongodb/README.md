...
Create a new **appSimpleUseSimpleUse.js** file and add the following code to try out some basic CRUD
...
Run your appSimpleUse from the command line with:

```bash
node appSimpleUse.jspleUse.js
```
...
Add to **appSimpleUse.jspleUse.js** the following function which uses the **insertMany**
...
Run the updated **appSimpleUseSimpleUse.js** file:
...
Add the ``indexCollection`` method to your appSimpleUse:
